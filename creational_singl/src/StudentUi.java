        ...
        while (true) {
            ...
            switch (choice) {
                case 1:
                    ...
                    for (String course : ((Students)loginSystem.getLoggedUser()).getCourses()) {
                ...
                case 2:
                    ...
                    ((Students)loginSystem.getLoggedUser()).addCourses(courseToAdd);
                    System.out.println("Course added.");
                    break;
                case 3:
                    System.out.print("Enter course to remove: ");
                    String courseToRemove = scanner.nextLine();
                    ((Students)loginSystem.getLoggedUser()).removeCourses(courseToRemove);
